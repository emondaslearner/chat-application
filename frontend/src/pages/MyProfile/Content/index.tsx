      ...
      <div className="w-[95%] sm:w-[80%] lg:w-[60%] mx-auto h-[100vh]">
        ...
        <div className="w-full border-b-[2px] border-light_border_ dark:border-dark_border_ flex items-center justify-between">
          <div
            ...
            className={`w-[48%] flex items-center justify-center py-2 cursor-pointer ${
              viewStatus === "list" && "border-b-[3px] border-primary_"
            }`}
          >
            <CiCircleList
              size={25}
          ...
          <div
            onClick={() => setViewStatus("grid")}
            className={`w-[48%] flex items-center justify-center py-2 cursor-pointer ${
              viewStatus === "grid" && "border-b-[3px] border-primary_"
            }`}
          >
            <IoGrid size={25} className="text-dark_ dark:text-dark_text_" />
            <p className="text-[20px] text-dark_ dark:text-dark_text_ font-semibold ml-2">
              Grid
            </p>
          </div>
        ...
        <div
          className={`w-full mt-3 ${
            viewStatus === "list"
              ? "gap-y-3 flex flex-col"
              : "grid grid-cols-2 gap-3"
          } h-full overflow-y-auto pb-[100px]`}
        >
